...
import { policyinfo } from "../style/other.module.scss";
  ...
  return (
    <div className={policyinfo}>
      <p>
        ...
        которую сайт Студия массажа Ложка Меда, (далее – Ложка Меда)
        расположенный на доменном имени lmmassage.ru (а также его субдоменах),
        может получить о Пользователе во время использования сайта lmmassage.ru
        ...
        сотрудники на управление сайтом Студия массажа Ложка Меда, действующие
        от имени ИП Арсентьева Анна Георгиевна, которые организуют и (или)
        ...
        <br />
        <br />
        1.1.5. «Сайт Студия массажа Ложка Меда» - это совокупность связанных
        между собой веб-страниц, размещенных в сети Интернет по уникальному
        адресу (URL): lmmassage.ru, а также его субдоменах.
        <br />
        <br />
        1.1.6. «Субдомены» - это страницы или совокупность страниц,
        расположенные на доменах третьего уровня, принадлежащие сайту Студия
        массажа Ложка Меда, а также другие временные страницы, внизу который
        указана контактная информация Администрации
        <br />
        <br />
        1.1.5. «Пользователь сайта Студия массажа Ложка Меда » (далее
        Пользователь) – лицо, имеющее доступ к сайту Студия массажа Ложка Меда,
        посредством сети Интернет и использующее информацию, материалы и
        продукты сайта Студия массажа Ложка Меда.
        <br />
        <br />
        ...
        через который Пользователь получает доступ на Ложка Меда.
        <br />
        <br />
        ...
        2. Общие положения
        <br />
        2.1. Использование сайта Студия массажа Ложка Меда Пользователем
        ...
        Пользователь должен прекратить использование сайта Студия массажа Ложка
        Меда .
        <br />
        <br />
        2.3. Настоящая Политика конфиденциальности применяется к сайту Студия
        массажа Ложка Меда. Ложка Меда не контролирует и не несет
        ответственность за сайты третьих лиц, на которые Пользователь может
        перейти по ссылкам, доступным на сайте Студия массажа Ложка Меда.
        <br />
        <br />
        ...
        предоставляет по запросу Администрации при регистрации на сайте Студия
        массажа Ложка Меда, при подписке на информационную e-mail рассылку или
        ...
        заполнения форм на сайте Студия массажа Ложка Меда и включают в себя
        ...
        <br />
        <br />
        3.3. Ложка Меда защищает Данные, которые автоматически передаются при
        посещении страниц:
        <br />
        - IP адрес;
        <br />
        ...
        <br />
        <br />
        3.3.2. Ложка Меда осуществляет сбор статистики об IP-адресах своих
        ...
        целях:
        <br />
        4.1.1. Идентификации Пользователя, зарегистрированного на сайте Студия
        массажа Ложка Меда для его дальнейшей авторизации, оформления заказа и
        других действий.
        <br />
        4.1.2. Предоставления Пользователю доступа к персонализированным данным
        сайта Студия массажа Ложка Меда.
        <br />
        4.1.3. Установления с Пользователем обратной связи, включая направление
        уведомлений, запросов, касающихся использования сайта Студия массажа
        Ложка Меда, оказания услуг и обработки запросов и заявок от
        Пользователя.
        <br />
        ...
        <br />
        4.1.6. Создания учетной записи для использования частей сайта Студия
        массажа Ложка Меда, если Пользователь дал согласие на создание учетной
        записи.
        <br />
        4.1.7. Уведомления Пользователя по электронной почте.
        <br />
        4.1.8. Предоставления Пользователю эффективной технической поддержки при
        возникновении проблем, связанных с использованием сайта Студия массажа
        Ложка Меда.
        <br />
        ...
        имени сайта Студия массажа Ложка Меда.
        <br />
        ...
        оформленного на сайте Студия массажа Ложка Меда, включая доставку
        Товара, документации или e-mail сообщений.
        <br />
        <br />
        ...
        данных, необходимых для использования сайта Студия массажа Ложка Меда, и
        ...
        которой он может иметь доступ как к части сайта Студия массажа Ложка
        Меда, несет лицо, предоставившее такую информацию.
        <br />
        <br />
        7.5. Пользователь соглашается, что информация, предоставленная ему как
        часть сайта Студия массажа Ложка Меда, может являться объектом
        ...
        такую информацию на сайте Студия массажа Ложка Меда. Пользователь не
        вправе вносить изменения, передавать в аренду, передавать на условиях
        займа, продавать, распространять или создавать производные работы на
        основе такого Содержания (полностью или в части), за исключением
        случаев, когда такие действия были письменно прямо разрешены
        собственниками такого Содержания в соответствии с условиями отдельного
        соглашения.
        <br />
        <br />
        7.6. В отношение текстовых материалов (статей, публикаций, находящихся в
        свободном публичном доступе на сайте Студия массажа Ложка Меда)
        ...
        коммуникационных данных, содержащихся на сайте Студия массажа Ложка Меда
        ...
        размещенную пользователем на сайте Студия массажа Ложка Меда, включая,
        ...
        Арбитражного суда г. Красноярск.
        <br />
        <br />
        ...
        размещения на сайте Студия массажа Ложка Меда, если иное не
        ...
        адресу http://lmmassage.ru/policy.html
        <br />
        <br />
        Обновлено: 06 Марта 2022 года
        <br />
        <br />
        г. Красноярск, ИП Арсентьева Анна Георгиевна ИНН 246217174251 ОГРНИП
        3192466800145586
      </p>
    </div>
  );
